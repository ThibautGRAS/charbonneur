...
window.HISTOIRE = {
  filons: [
    { year: 1906, titre: 'Naissance dans le charbon', image: 'images/fond/fond.png',
      recit: [
    ...
    { year: 1934, titre: 'Le Racing passe professionnel', image: 'images/defaut/stade.jpg',
      recit: [
    ...
    { year: 1998, titre: 'Champion de France', image: 'images/defaut/kop.jpg',
      recit: [
