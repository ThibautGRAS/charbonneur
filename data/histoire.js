...
window.HISTOIRE = {
  ...
  legendes: [
    { name: 'Daniel Leclercq', role: 'Entraîneur', era: 'Le Druide · sacre 1998',
    ...
    { name: 'Vladimír Šmicer', role: 'Milieu', era: '1996-1999',
    ...
    { name: 'Raphaël Varane', role: 'Défenseur', era: 'Formé à La Gaillette',
