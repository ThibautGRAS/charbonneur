# 📋 REGISTRE DES DOSSIERS — état canonique du mercato & du club
> Lu OBLIGATOIREMENT par toute session /maj AVANT d'écrire un article,
> et mis à jour APRÈS chaque commit d'article. C'est la mémoire anti-fausses-news.
> Format : statut · dernier fait daté · source.

*Dernière mise à jour : 2026-08-19 (session newsletter/garde-fous)*

## ✅ OFFICIEL — arrivées été 2026
- **Dino Toppmöller** (entraîneur) — 1er match officiel gagné (Trophée des Champions, 16/08).
- **Michaël Cuisance** (M).
- **Michał Skóraś** (ailier, La Gantoise, ~8 M€, mi-juillet).
- **Yacine Titraoui** (M, Charleroi, n°8, contrat 2031) — officiel 03/08.
- **Franjo Ivanović** (A, prêt Benfica) — officiel 12-13/08.
- **Maik Nawrocki** (D, n°3) — officiel 15/08, titulaire dès le Trophée des Champions.

## ✅ OFFICIEL — départs été 2026
- **Sangaré** → Brentford (~48 M€, vente record).
- **Saïd** → Al Shamal (Qatar) — officiel 17/08.
- **Thomasson** → Rennes. **Sarr**, **Gorgelin**, **Gurtner** : départs actés.
- **Pagis** → Lorient (prêt). **Sylla** → Sion.
- **Sotoca** : TOUJOURS AU CLUB (actionnaire du RC Narbonnais à titre privé, 04/07). Brassard transmis à **Thauvin** (officiel, feuille de match 08/08 et 16/08).
